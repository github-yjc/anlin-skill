...
1. First `draft.md` must already be a complete article with title, about 950-1150 body Chinese characters, roughly 45-70 body lines, mixed short and long lines, and several early comma-ended continuation lines. Do not write 8-15 giant prose lines, 100 tiny lines, or an overfilled 1350+ character article that stacks body/screen/object details just to pass checks. A draft can also fail by looking superficially line-broken but underbuilt: around 700-900 characters, 45-75 similar short rows, almost no long action/speech/thought lines, and no rough middle engine. Rebuild that from the source loop before saving; do not pad it with a few extra symptoms or captions.
