...
- A thought-turn is not a paragraph: when an observation, crooked read, and next move occur inside one fragment, write their breathing rows before the first artifact; a rhythm script cannot invent missing source movement.
