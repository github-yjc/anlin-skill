...
4. Do not run the second checker until the current `draft.md` is the version you are ready to output unchanged. After the second checker, the next and only tool action may be reading `draft.md`; no third write, no third checker, no manual final repair, even if errors remain.
