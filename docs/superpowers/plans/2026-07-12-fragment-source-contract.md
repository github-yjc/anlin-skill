...
~~~powershell
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_active_runtime_uses_fragment_source_contract
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_corpus_observed_range_matches_source_model
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_fragment_and_social_decline_checker_pairs
~~~
...
~~~powershell
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_fragment_and_social_decline_checker_pairs
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_checker_draft_gate_promotes_comma_rhythm_in_sparse_draft
~~~
...
~~~powershell
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_bounded_repair_uses_wrapper_output_without_long_reference_reload
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_formal_first_draft_uses_source_loop_not_long_repair_files
python -m unittest test.test_anlin_tooling.AnlinToolingTests.test_source_contract_uses_fragment_slate_not_carrier_engine
~~~
