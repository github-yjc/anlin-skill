        ...
        [
            ...
            *(
                [
                    ...
                    "standard_public_hinge_guard: a neighbor/cashier/rider appearing is not enough. The other person must wait, ask, react to, block, expose, or change the wet/dirty/payment/reply/body fact in the same action chain; an informational cameo beside private texture still fails.",
