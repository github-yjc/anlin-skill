...
def build_subagent_prompt(output_dir: Path, num_total: int) -> str:
    ...
    lines = [
        ...
        "",
        "Use only the sample texts in this directory. Do not use style skills,",
        "author-specific skills, external memories, web search, corpus files,",
        "mapping files, filenames outside sample-*.txt, or prior knowledge about",
        "the named source. Treat the source as anonymous.",
        "",
        "Your task:",
        "",
