...
A legal-looking line count is not enough. A 700-900 character draft with 45-75 short rows, weak paragraph engine, no rough social/body turn, and almost no longer action/speech/thought lines is an underbuilt source shape. Repair it by rebuilding from the source loop, not by adding isolated symptoms, app details, money facts, or decorative short drops. The rebuilt middle should change action, social position, body consequence, route, payment, or reply.
